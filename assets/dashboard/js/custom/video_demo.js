                ...
                //if (description != "") { 
                      if (action == "Save") {
                          if (thumnail != "") {
                              if (img != "") {
                                   $('#loadingDiv').show(); 
                                   $("input[type='file']").upload(base_url+'Video/dataSave',{banner_name: banner_name,img:img},function(res){
                                        console.log(res);
                                        if (res>0)
                                         {
                                              loadData();   
                      ...
                      if (action == "Update") {
                          ...
                          $('#loadingDiv').show();
                               if (thumnail != "" || img != "") {  
                                   $("input[type='file']").upload(base_url+'Video/dataUpdate',{banner_id:banner_id,banner_name: banner_name,img:img, thumnail:thumnail},function(res){
                                        if (res>0)
                                         {
                                              loadData(); 
             ...
             for (var i = 0; i < data['data']['length']; i++)
              {
                  ...
                  html += "<td><video controls height='200px' width='200px'><source src="+base_url+'Service_Video/'+data['data'][i]['path']+" type='video/ogg' /><source src="+base_url+'Service_Video/'+data['data'][i]['path']+" type='video/mp4' /></video></td>";
