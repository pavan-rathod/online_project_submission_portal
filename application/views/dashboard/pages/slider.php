                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">                                                     
                            <div class="row">
                                <div class="col-md-3">
                                    <label for="tehsil-name" class="col-form-label">Slogan :<span class="compulsoryField">&nbsp;*</span></label>
                                </div>
                                <div class="col-md-9">
                                    <input type="hidden" class="form-control" id="txt_banner_id">  
                                    <input type="text" class="form-control" id="txt_banner_name" placeholder="Slogan">
                                </div>                                                        
                            </div><br />
                            <!-- <div class="row">
                                <div class="col-md-3">
    ...
    <script src="<?=base_url()?>assets/dashboard/js/custom/slider.js"></script> 