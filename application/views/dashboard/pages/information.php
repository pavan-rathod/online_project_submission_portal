                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">                                                     
                            <div class="row">
                                <div class="col-md-3">
                                    <label for="tehsil-name" class="col-form-label">Information :<span class="compulsoryField">&nbsp;*</span></label>
                                </div>
                                <div class="col-md-9">
...
<!--                             <div class="row">
    ...
    <script src="<?=base_url()?>assets/dashboard/js/custom/information.js"></script> 