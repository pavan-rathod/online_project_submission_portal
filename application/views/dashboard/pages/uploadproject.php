                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <label for="recipient-name" class="col-form-label">Academic Year :<span class="compulsoryField">&nbsp;*</span></label>
                                </div>
                                <div class="col-md-9">
                                    <select class="form-control searchData" id="year">
                                    </select> 
                                </div>                                                        
                            </div><br />                          
                            <div class="row">
                            ...
                            <div class="row">
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-9"> 
                                    <input type="text" class="form-control" id="txt_title" placeholder="Project Title">
                                </div>                                                        
                            </div><br /> 
                            <div class="row">
                                <div class="col-md-3">
    ...
    <script src="<?=base_url()?>assets/dashboard/js/custom/uploadproject.js"></script> 