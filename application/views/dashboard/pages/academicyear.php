    <section class="content"> 
        <div class="container-fluid">
            <ol class="breadcrumb breadcrumb-bg-teal">
                ...
                <li><a href="javascript:void(0);"><i class="material-icons">desktop_mac</i> Project Liabrary</a></li>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">  
                            <div class="row">
                                <div class="col-md-3">
                                    <label for="recipient-name" class="col-form-label">Enter Start Year :<span class="compulsoryField">&nbsp;*</span></label>
                                </div>
                                <div class="col-md-9">
                                    <input type="hidden" class="form-control" id="txt_id">  
                                    <input type="text" class="form-control" id="txt_startyear" placeholder="Enter Start Year">
                                </div>                                                        
                            </div><br />  
                            <div class="row">
                                <div class="col-md-3">
                                    <label for="recipient-name" class="col-form-label">Enter End Year :<span class="compulsoryField">&nbsp;*</span></label>
                                </div>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" id="txt_endyear" placeholder="Enter End Year ">
                                </div>                                                        
                            </div><br />
                            ...
                            <!-- <div class="row">
                                ...
                                <div class="col-md-9">
                                    <input type="hidden" class="form-control" id="txt_id">  
                                    <input type="text" class="form-control" id="txt_name" placeholder="Technology Name">
                                </div>                                                        
                            </div><br />  --> 
<!--                             <div class="row">
                                <div class="col-md-3">
    ...
    <script src="<?=base_url()?>assets/dashboard/js/custom/academicyear.js"></script> 