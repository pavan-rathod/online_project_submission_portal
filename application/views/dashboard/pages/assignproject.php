    <section class="content"> 
        <div class="container-fluid">
            <ol class="breadcrumb breadcrumb-bg-teal">
                ...
                <li class="active"><i class="material-icons">group_add</i> <?=$heading ?></li>
             </ol> 
            <!-- Basic DataTable -->
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body"> 
                            <div class="row">
                                <div class="col-md-3">
                                    <label for="recipient-name" class="col-form-label">Teacher :<span class="compulsoryField">&nbsp;*</span></label>
                                    <input type="hidden" class="form-control" id="txt_id">  
                                </div>
                                <div class="col-md-9">
                                    <select class="form-control searchData" id="teacher">
                                    </select> 
                                </div>                                                        
                            </div><br />                          
                            <div class="row">
                                <div class="col-md-3">
                                    <label for="recipient-name" class="col-form-label">Project :<span class="compulsoryField">&nbsp;*</span></label> 
                                </div>
                                <div class="col-md-9">
                           ...
                           <!--  <div class="row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control searchData" id="technology">
                                    </select> 
                                </div>                                                        
                            </div><br /> -->                                                                                                         
<!--                             <div class="row">
    ...
    <script src="<?=base_url()?>assets/dashboard/js/custom/assignproject.js"></script> 